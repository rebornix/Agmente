...
struct JSONRPCFormatter {
    static func idString(_ id: JSONRPCID) -> String {
        switch id {
    ...
    static func compact(_ value: JSONValue, encoder: JSONEncoder) -> String {
        compact(data: (try? encoder.encode(value)) ?? Data())
    }

    static func compact(_ object: [String: JSONValue], encoder: JSONEncoder) -> String {
